...
def create_custom_objects():
    ...
    def my_loss(*args):
        method = getattr(instanceHolder['instance'], 'my_loss')
        return method(*args)
    ...
    return {'ChainCRF': ChainCRFClassWrapper, 'ChainCRFClassWrapper': ChainCRFClassWrapper, 'my_loss': my_loss, 'loss': loss, 'sparse_loss': sparse_loss}
